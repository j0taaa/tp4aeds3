...
/**
 * LZW
 * Classe que implementa o algoritmo LZW para compressão e descompressão de arquivos.
 */
public class LZW {
  ...
  /**
   * Inverte um dicionário de String -> Integer para Integer -> String
   * @param dict
   * @return
   */
  ...
  /**
   * Comprime um arquivo de entrada e salva o resultado em um arquivo de saída. Ele funciona ao ler o arquivo de entrada byte a byte e tenta encontrar a maior sequência de bytes que já foi vista. Se não encontrar, ele adiciona a sequência atual ao dicionário e começa a procurar a próxima sequência.
   * @param fileIn
   * @param fileOut
   * @throws Exception
   */
  ...
  /**
   * Descomprime um arquivo de entrada e salva o resultado em um arquivo de saída. Ele funciona ao ler o arquivo de entrada byte a byte e tenta encontrar a maior sequência de bytes que já foi vista. Se não encontrar, ele adiciona a sequência atual ao dicionário e começa a procurar a próxima sequência.
   * @param fileIn
   * @param fileOut
   * @throws Exception
   */
  ...
  /**
   * Função principal que realiza a compressão e descompressão de um arquivo. Criada para fins de teste.
   * @param args
   */
